...
<div id="switcher">
	<ul>
		...
		<li class="content-item"><a class="content-button" href="#content"><?php _e( 'text', 'commentpress-core' ); ?></a></li>
		<li class="sidebar-item"><a class="sidebar-button" href="#sidebar"><?php _e( 'COMMENTARY', 'commentpress-core' ); ?></a></li>
	</ul>
</div>
