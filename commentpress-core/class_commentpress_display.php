	...
	public function get_paragraph_icon(
		...
		switch ( $block_type ) {
			...
			default:
				...
				$para_marker = '<span class="para_marker"><a class="textblock_permalink" id="' . $text_signature . '" href="#' . $text_signature . '" title="' . $permalink_text . '"><span>' . (string) $para_num . '</span></a></span>';
